...
const config = {
  ...
  openai: {
    ...
    fallbackModel: 'gpt-4o-mini-realtime-preview-2024-12-17', // Fallback to versioned model if new alias fails
  ...
  voice: {
    ...
    vadType: 'semantic_vad' // Use semantic VAD for better conversation understanding
  },
  ...
  audioProcessing: {
    enabled: process.env.AUDIO_PROCESSING_ENABLED === 'true', // Default: false (disabled until fixed)
